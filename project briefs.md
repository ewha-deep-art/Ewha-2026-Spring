...
| Pain Point (해결할 문제) | 본 프로젝트는 AI 기술을 활용하여 전시 작품에 대한 오디오 도슨트 콘텐츠를 자동으로 생성하는 서비스를 개발하는 것을 목표로 한다. 기존 오디오 도슨트는 전문 도슨트의 해설 작성과 녹음 과정을 통해 제작되기 때문에 시간과 비용이 많이 소요되며, 소규모 전시나 개인 전시에서는 도입이 어려운 경우가 많다.
이에 전시 기획자가 작품 이미지와 작품 정보를 입력하면 AI가 도슨트 해설을 자동으로 생성하고 이를 음성으로 변환하여 오디오 도슨트 콘텐츠를 제작할 수 있는 서비스를 구축하고자 한다. 추가적으로 배리어프리 모드를 통해, 시각장애인의 전시 해설 서비스 접근성을 높이고, 작품의 시각적 요소를 보다 자세히 설명하는 해설 기능을 제공하고자 한다. |
| 사용 기술 | LMM으로 분석, LLM 기반 콘텐츠 생성, RAG 기반 전시 정보 활용, 음성 합성(TTS) 기술 |
| 기대 효과 | 소규모 전시 기획자가 작품 이미지와 작품 정보를 입력하면 AI가 도슨트 해설을 자동으로 생성하고 이를 음성으로 변환하여 오디오 도슨트 콘텐츠를 제작할 수 있는 서비스를 구축하고자 한다. 추가적으로 배리어프리 모드를 통해, 시각장애인의 전시 해설 서비스 접근성을 높이고, 작품의 시각적 요소를 보다 자세히 설명하는 해설 기능을 제공하고자 한다. |
